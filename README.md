...
4. The Heart of The Project: A demo video showcasing our initial build was created. [Demo](challenges/demo1.mp4)


## Week 3: The Impact & Refinement Phase

1. The Code Meme & Team Identity: A light-hearted round spent making meme collages. [memes](challenges/memes.jpeg)
2. The Global Impact Mapping: An idenitification of the global impact our project contributed to was drafted. [SDG goals](challenges/SDGgoals.pdf)
3. The Core Error-Handling: We proved our code can handle chaotic user input, and dealt with edge cases. [Error Handling](challenges/CoreErrorHandling.pdf)
4. The Optimization Milestone: We optimized our app to run faster, and added various quality-of-life features. [Demo](challenges/demo2.mp4)
...
This project was developed by Team Cipher Syndicate:

| Name | GitHub |
|---|---|
| Faizah Hafeez | [@faizahhafeez2-code](https://github.com/faizahhafeez2-code) |
| Sakina Fatima Mirza | [@sakinastlw110](https://github.com/sakinastlw110) |
| Samee | [@silasiel](https://github.com/silasiel) |
